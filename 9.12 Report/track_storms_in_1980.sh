...
FILELISTNAME=MERRA2_filelist.txt
DATESTRING='198001'
DCU_PSLFOMAG=200.0
DCU_PSLFODIST=5.5
...
TOPOFILE=/home/cl4460/9.10/MERRA2.topo.nc
...
${TEMPESTEXTREMESDIR}bin/StitchNodes --in cyclones.${DATESTRING} --out "MERRA2_second_trail.dat" --in_fmt "lon,lat,slp,wind,PHIS" --range ${SN_TRAJRANGE} --mintime "54h" --maxgap "24h" --threshold "wind,>=,10.0,10;lat,<=,50.0,10;lat,>=,-50.0,10;PHIS,<=,${SN_MAXTOPO},${SN_MINLEN}" </dev/null
