...
def read_format_(filename):
    ...
    if non_scalar_found:
        print("Error: 非标量元素存在于 data_dict 中。请检查数据源。")
        raise ValueError("非标量元素存在于 data_dict 中。")
...
if __name__ == "__main__":
    data_file_path = '/home/cl4460/TE_whole_year/MERRA2_second_trail.dat'
    try:
