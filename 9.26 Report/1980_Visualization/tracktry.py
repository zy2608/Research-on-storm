...
df = pd.read_csv('convert_dataset.dat', delim_whitespace=True, header=None, names=column_names, skiprows=1)
...
cbar = plt.colorbar(scalar_map, orientation='vertical', pad=0.02, shrink=0.7)
