...
scalar_map.set_array(range(num_storms))  


cbar = plt.colorbar(scalar_map, orientation='vertical', pad=0.02, shrink=0.7, ax=ax)
cbar.set_label('Storm Index')
plt.title('Storm Tracks from March in 2022')
output_file = 'storm_tracks_March_in_2022.png'
